    ...
    methods
        function f = score(this,X,doclass)
            %doclass: true for classification, or false for regression.
             ...
             if classreg.learning.coderutils.fxpt.isfxpt(X)
                 error(message('stats:classreg:learning:impl:CompactSVMImpl:score:BadXfi'));
             end
