...
%   Copyright 2016-2018 The MathWorks, Inc.
    ...
    methods(Static)
        ...
        function Obj = makeBayesoptInfo(FitFunctionName, Predictors, Response, FitFunctionArgs)
            switch FitFunctionName
                ...
                case 'fitckernel'
                    ConstructorFcn = @classreg.learning.paramoptim.BayesoptInfoCKernel;
                case 'fitcknn'
                ...
                case 'fitrkernel'
                    ConstructorFcn = @classreg.learning.paramoptim.BayesoptInfoRKernel;
                case 'fitrlinear'
                    ConstructorFcn = @classreg.learning.paramoptim.BayesoptInfoRLinear;
                case 'fitrsvm2'
                    ConstructorFcn = @BayesoptInfoRSVM2;
                case 'fitrtree'
    ...
    methods(Access=protected)
        function this = BayesoptInfo2(Predictors, Response, FitFunctionArgs, ObservationsInCols, IsRegression)
        ...
        function this = computeInMemoryDatasetStats(this, Predictors, Response, FitFunctionArgs, ObservationsInCols, IsRegression)
            this.IsRegression = IsRegression;
            ...
            if isnumeric(Predictors)
                Predictors(isinf(Predictors)) = NaN;    % Convert Infs to NaN in preparation for next line.
...
if isequal(OptimizeHyperparameters, 'auto') || isequal(OptimizeHyperparameters, 'all')
    return;
elseif ischar(OptimizeHyperparameters)
    OptimizeHyperparameters = cellstr(OptimizeHyperparameters);
end

if iscellstr(OptimizeHyperparameters)
